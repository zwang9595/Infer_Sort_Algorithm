...
public class Main_fixed {
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		URL url = Sort.class.getProtectionDomain().getCodeSource().getLocation();
		...
		Integer[] test3 = intArrayReader1(path + "itest2.txt");
		...
		// Also test for resource leak
		// Comment this section to pass the test
		String[] test6 = stringArrayReader1(path + "stest2.txt");
